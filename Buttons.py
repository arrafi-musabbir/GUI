...
class buttons:
    ...
    def pushbutton1(self):  # on - off
        ...
        self.button1.setGeometry(QtCore.QRect(
            cg.button1_x, cg.button1_y, cg.button1_width, cg.button1_height))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(self.cwd + "/" + cg.push_button),
                       QtGui.QIcon.Active, QtGui.QIcon.On)
        self.button1.setIcon(icon)
        self.button1.setIconSize(QtCore.QSize(
            cg.button1_width, cg.button1_height))
    ...
    def pushbutton2(self):  # delete last entry
        ...
        self.button2.setGeometry(QtCore.QRect(
            cg.button2_x, cg.button2_y, cg.button2_width, cg.button2_height))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(self.cwd + "/" + cg.refresh),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button2.setIcon(icon)
        self.button2.setStyleSheet(
            "border-radius : 50; border : .1px solid black")
        self.button2.setIconSize(QtCore.QSize(
            cg.button2_width, cg.button2_height))
    ...
    def pushbutton3(self):  # goto settings tab
        ...
        self.button3.setGeometry(QtCore.QRect(
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(self.cwd + "/" + cg.settings),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button3.setIcon(icon)
        self.button3.setStyleSheet(
            "border-radius : 50; border : .1px solid black")
        self.button3.setIconSize(QtCore.QSize(
            cg.button3_width, cg.button3_height))
    ...
    def pushbutton4(self):  # go back
        ...
        self.button4.setGeometry(QtCore.QRect(
            cg.button4_x, cg.button4_y, cg.button4_width, cg.button4_height))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(self.cwd + "/" + cg.goBack),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button4.setIcon(icon)
        self.button4.setStyleSheet(
            "border-radius : 50; border : .1px solid black")
        self.button4.setIconSize(QtCore.QSize(
            cg.button4_width, cg.button4_height))
    ...
    def pushbutton5(self):  # show device registrinformations
        ...
        self.button5.setGeometry(QtCore.QRect(
            cg.button3_x, cg.button3_y, cg.button2_width, cg.button2_height))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(self.cwd + "/" + cg.credits),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button5.setIcon(icon)
        self.button5.setStyleSheet(
            "border-radius : 50; border : .1px solid black")
        self.button5.setIconSize(QtCore.QSize(
            cg.button5_width, cg.button5_height))
    ...
    def pushbutton6(self):  # show server settings
        ...
        self.button6.setGeometry(QtCore.QRect(
            cg.button1_x + 10, cg.button1_y - 50, cg.button6_width, cg.button6_height))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(
            self.cwd + "/" + cg.server_settings), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button6.setIcon(icon)
        self.button6.setStyleSheet(
            "border-radius : 50; border : .1px solid black")
        self.button6.setIconSize(QtCore.QSize(
    ...
    def pushbutton7(self):  # show display settings
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(self.cwd + "/" + cg.display),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button7.setIcon(icon)
        self.button7.setStyleSheet(
            "border-radius : 50; border : .1px solid black")
        self.button7.setIconSize(QtCore.QSize(
            cg.button6_width, cg.button6_height))
    ...
    def reconnectServer(self):  # reconnect server
        ...
        self.button9.setGeometry(QtCore.QRect(
            cg.button9_x, cg.button9_y, cg.button9_width, cg.button9_height))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(self.cwd + "/" +
                       cg.reconnectServer), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.button9.setIcon(icon)
        self.button9.setIconSize(QtCore.QSize(
            cg.button9_width, cg.button9_height))
