...
class spreadSheet:
    ...
    def connectSheet(self):
        try:
            ...
            print(
                "couldn't establish a connection with google spreadsheet\nCheck your internet connections")
            return False
    ...
    def importCSV(self):
        try:
            content = open(os.path.join(self.csv_path, 'exportedFromDB_{}.csv'.format(
                datetime.today().strftime('%d %b %Y'))), 'r').read()
